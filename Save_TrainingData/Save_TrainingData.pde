...
void analysisData(String myString){
  ...
  if(list.length == 6){
    ...
    if(getABSMax(IMUDataArray.get(2))>14 && (currenttime-lastTimeTriggered) >3000){
      ...
      // Half of the sample is clockwisee, the other half is anticlockwise
      if(upDownCnt++< numofTrainingSamples/6){
          featurelist[9] = (double) attsResult.indexOf("Up"); 
          System.out.println("Sample Counter:" + samplecounter +"  Up");

      }else if(upDownCnt <= 20 && upDownCnt >= 10){
          featurelist[9] = (double) attsResult.indexOf("Down"); 
          System.out.println("Sample Counter:" + samplecounter +"  Down");
      }
      
      //only collect 10 samples per motion!
      if(upDownCnt <= 20){
      System.out.println(featurelist[0] +","+featurelist[1] +","+featurelist[2]);
    ...
    if(getABSMax(IMUDataArray.get(0))>4 && (currenttime-lastTimeTriggered) >3000){
      ...
      // Half of the sample is clockwisee, the other half is anticlockwise
      if(pCnt++< numofTrainingSamples/6){
          featurelist[9] = (double) attsResult.indexOf("Punch"); 
          System.out.println("Sample Counter:" + samplecounter +"  Punch");

      }
      
      //only collect 10 samples per this motion!
      if(pCnt <= 10){
      System.out.println(featurelist[0] +","+featurelist[1] +","+featurelist[2]);
      DenseInstance addinstance = new DenseInstance(1.0, featurelist);
      mInstances.add(addinstance);
    ...
    if(getMax(IMUDataArray.get(1))>7 && (currenttime-lastTimeTriggered) >3000){
      ...
      if(tCnt++< numofTrainingSamples/6){
          featurelist[9] = (double) attsResult.indexOf("Tap"); 
          System.out.println("Sample Counter:" + samplecounter +"  Tap");
    ...
    if(getMin(IMUDataArray.get(1))<-4 && (currenttime-lastTimeTriggered) >3000){
      ...
      // Half of the sample is clockwisee, the other half is anticlockwise
      if(lrCnt++< numofTrainingSamples/6){
          featurelist[9] = (double) attsResult.indexOf("Left"); 
    ...
    if(getABSMax(IMUDataArray.get(3))>2 && (currenttime-lastTimeTriggered) >3000){
      ...
      // Half of the sample is clockwisee, the other half is anticlockwise
      if(gyroCnt++< numofTrainingSamples/6){
          featurelist[9] = (double) attsResult.indexOf("Snap"); 
          System.out.println("Sample Counter:" + samplecounter +"  Snap");
